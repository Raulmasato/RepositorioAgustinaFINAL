namespace AutoVentas.UI.Formularios.Vendedor
{
    partial class FrmPresupuestos
    {
        ...
        private void InitializeComponent()
        {
            ...
            this._grilla.Columns.Add(new System.Windows.Forms.DataGridViewTextBoxColumn { DataPropertyName = nameof(AutoVentas.Domain.Entidades.Presupuesto.IdPresupuesto), HeaderText = "Id", Width = 50, Visible = false });
            this._grilla.Columns.Add(new System.Windows.Forms.DataGridViewTextBoxColumn { DataPropertyName = nameof(AutoVentas.Domain.Entidades.Presupuesto.VehiculoDescripcion), HeaderText = "Vehículo" });
            this._grilla.Columns.Add(new System.Windows.Forms.DataGridViewTextBoxColumn { DataPropertyName = nameof(AutoVentas.Domain.Entidades.Presupuesto.ClienteNombreCompleto), HeaderText = "Cliente" });
            this._grilla.Columns.Add(new System.Windows.Forms.DataGridViewTextBoxColumn { DataPropertyName = nameof(AutoVentas.Domain.Entidades.Presupuesto.FechaPresupuesto), HeaderText = "Fecha" });
            this._grilla.Columns.Add(new System.Windows.Forms.DataGridViewTextBoxColumn { DataPropertyName = nameof(AutoVentas.Domain.Entidades.Presupuesto.Monto), HeaderText = "Monto" });
            this._grilla.Columns.Add(new System.Windows.Forms.DataGridViewTextBoxColumn { DataPropertyName = nameof(AutoVentas.Domain.Entidades.Presupuesto.Estado), HeaderText = "Estado" });
            //
            // _panelBotones
            //
