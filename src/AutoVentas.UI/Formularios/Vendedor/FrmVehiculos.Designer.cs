namespace AutoVentas.UI.Formularios.Vendedor
{
    partial class FrmVehiculos
    {
        ...
        private void InitializeComponent()
        {
            ...
            this._grilla.Columns.Add(new System.Windows.Forms.DataGridViewTextBoxColumn { DataPropertyName = nameof(AutoVentas.Domain.Entidades.Vehiculo.IdVehiculo), HeaderText = "Id", Width = 50 });
            ...
            this._grilla.Columns.Add(new System.Windows.Forms.DataGridViewCheckBoxColumn { DataPropertyName = nameof(AutoVentas.Domain.Entidades.Vehiculo.Disponible), HeaderText = "Disponible" });
            //
            // _panelBotones
            //
