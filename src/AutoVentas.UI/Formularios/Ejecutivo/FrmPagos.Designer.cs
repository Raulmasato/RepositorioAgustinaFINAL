namespace AutoVentas.UI.Formularios.Ejecutivo
{
    partial class FrmPagos
    {
        ...
        private void InitializeComponent()
        {
            ...
            this._grilla.Columns.Add(new System.Windows.Forms.DataGridViewTextBoxColumn { DataPropertyName = nameof(AutoVentas.Domain.Entidades.Pago.IdPago), HeaderText = "Id", Width = 50, Visible = false });
            this._grilla.Columns.Add(new System.Windows.Forms.DataGridViewTextBoxColumn { DataPropertyName = nameof(AutoVentas.Domain.Entidades.Pago.ContratoDescripcion), HeaderText = "Contrato" });
            this._grilla.Columns.Add(new System.Windows.Forms.DataGridViewTextBoxColumn { DataPropertyName = nameof(AutoVentas.Domain.Entidades.Pago.Monto), HeaderText = "Monto" });
            this._grilla.Columns.Add(new System.Windows.Forms.DataGridViewTextBoxColumn { DataPropertyName = nameof(AutoVentas.Domain.Entidades.Pago.FechaPago), HeaderText = "Fecha" });
            this._grilla.Columns.Add(new System.Windows.Forms.DataGridViewTextBoxColumn { DataPropertyName = nameof(AutoVentas.Domain.Entidades.Pago.MetodoPago), HeaderText = "Método" });
            //
            // _panelBotones
            //
