namespace AutoVentas.UI.Formularios.Ejecutivo
{
    partial class FrmReportes
    {
        ...
        private void InitializeComponent()
        {
            ...
            // _btnExportarPdf
            //
            this._btnExportarPdf.AutoSize = true;
            this._btnExportarPdf.Name = "_btnExportarPdf";
            this._btnExportarPdf.TabIndex = 4;
            this._btnExportarPdf.Text = "Exportar a PDF";
            this._btnExportarPdf.UseVisualStyleBackColor = true;
            this._btnExportarPdf.Click += new System.EventHandler(this.BtnExportarPdf_Click);
            //
            ...
            this._panelBotones.Controls.Add(this._btnExportarPdf);
            //
            // FrmReportes
            //
            this.Text = "Reportes";
